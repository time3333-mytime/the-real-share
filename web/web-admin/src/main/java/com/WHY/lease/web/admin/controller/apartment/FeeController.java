...
import com.WHY.lease.web.admin.vo.fee.FeeKeyVo;
import com.WHY.lease.web.admin.service.FeeKeyService;
import com.WHY.lease.web.admin.service.FeeValueService;
...
public class FeeController {
    ...
    public Result saveOrUpdateFeeKey(@RequestBody FeeKey feeKey) {
        keyService.saveOrUpdate(feeKey);
        return Result.ok();
    }
    ...
    public Result saveOrUpdateFeeValue(@RequestBody FeeValue feeValue) {
        valueService.saveOrUpdate(feeValue);
        return Result.ok();
    }
    ...
    public Result<List<FeeKeyVo>> feeInfoList() {
        List<FeeKeyVo> list=keyService.listFeeInfo();
