...
public class Knife4jConfiguration {
    ...
    @Bean
    public GroupedOpenApi informationAPI() {
        return GroupedOpenApi.builder().group("信息").
                pathsToMatch("/app/information/**").
                build();
    }
    @Bean
    public GroupedOpenApi upAPI() {
        return GroupedOpenApi.builder().group("上传信息").
