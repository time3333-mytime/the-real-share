...
export function ToPay(id: number | string) {
  return http.get<String>(`/app/agreement/toPay?id=${id}`);
}
/**
 * @description 根据房间id获取可选获取租期列表
 * @param roomId
 */
export function getTermListByRoomId(roomId: number | string | undefined) {
