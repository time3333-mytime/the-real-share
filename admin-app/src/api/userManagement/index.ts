...
import {NewUserStatus, UserStatus} from '@/enums/constEnums'
/**
...
export function getUserManagementInfoList2(
  params: UserManagementListQueryInterface,
) {
  return http.get<PageRes<UserManagementInfoInterface[]>>(`/admin/user/page2`, {
    current: params.pageNum,
    size: params.pageSize,
    phone: params.phone,
    status: params.status,
...
export function updateUserManagementStatus2(
  id: number | string,
